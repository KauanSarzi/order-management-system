...
public class CustomerService {
    ...
    public CustomerResponse findById(@NonNull Long id) {
        return CustomerResponse.from(findEntityById(id));
    }

    public Customer findEntityById(@NonNull Long id) {
    ...
    public CustomerResponse update(@NonNull Long id, CustomerRequest request) {
